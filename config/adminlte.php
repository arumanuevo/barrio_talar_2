...
return [
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'images/Logo Talar del Lago 1.svg',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
    ...
    */
    ...
    'preloader' => [
        ...
        'mode' => 'fullscreen',
        'img' => [
            'path' => 'images/logotalararbol2.svg',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Consumos por periodo',
                    'url' => 'calculoConsumos',
                ],
                [
                    'text' => 'Graficos Consumos',
                    'url' => 'grafico-consumos',
                    'can' => 'administrador',
                ],
                [
                    'text' => 'Otros',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'url' => 'vistaMedicionesLote',
                    'can' => 'usuario',
                ],
                [
                    'text' => 'Ultimos Consumos',
                    'url' => 'ultimosConsumos',
                    'can' => 'administrador',
                ],
                [
                    'text' => 'Graficos',
                    'url' => 'getFacturasGrafVista',
                    'can' => 'usuario',
                ],
                [
                    'text' => 'Medidores',
